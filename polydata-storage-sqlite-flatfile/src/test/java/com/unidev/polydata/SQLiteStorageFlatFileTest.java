...
/**
 * Tests for sqlite and flat file storage.
 */
public class SQLiteStorageFlatFileTest {
    ...
    public void setup() throws IOException {
        ...
        dbFile.delete();
        FileUtils.deleteDirectory(new File(dbFile.getParentFile(), SQLiteStorageFlatFile.FILES_FOLDER));
    }
    ...
    private SQLiteStorageFlatFile openDbStorage() {
        SQLiteStorageFlatFile flatFileSqliteStorage = new SQLiteStorageFlatFile(dbFile.getAbsolutePath());
        flatFileSqliteStorage.migrateStorage();
        return flatFileSqliteStorage;
    }

    @Test
    public void testPersistingPoly() throws SQLException {
        SQLiteStorageFlatFile sqLiteStorage = openDbStorage();
